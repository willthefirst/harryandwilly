...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    var reset = function() {
        ...
        console.log('understand this stuff');
    };
    ...
    var render = function() {
        ...
        // Will's Addition: Fastest Kill Time
        ctx.fillText("Fastest catch: " + fastestCatch + "s", 32, 64);
